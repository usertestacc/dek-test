        ...
        <form className='max-w-xl mx-auto p-2'>
            ...
            <div className='relative'>
                ...
                <input
                    type='search'
                    id='default-search'
                    className='block w-full border border-gray-900 p-4 ps-10 text-sm rounded-lg bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-10 
